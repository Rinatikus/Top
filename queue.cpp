...
bool	run ()
{
    ...
    */
    ...
    /*
    ** Выводим содержимое контейнера, всегда первый элемент и затем "выталкиваем" элемент, на
    ** стандартный вывод
    */
    while ( ! user_strings.empty()) {
        cout << user_strings.front().c_str() << endl;
        user_strings.pop();
    };
