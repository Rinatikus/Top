...
#define	__STDC_WANT_LIB_EXT1__	1	// расширение для безопасной работы функций
...
# define	_CRT_SECURE_NO_DEPRECATE	// отключает предупреждения функций стиля Кернигана и Ричи
#endif
...
# define	cout	wcout
# define	cin		wcin
# define	streambuf	wstreambuf
# define	istream	wistream
# define	isdigit	_iswdigit
...
# define	_finddata_t	_wfinddata64_t
# define	_findfirst	_wfindfirsti64
# define	_findnext	_wfindnexti64
# define	fopen	_wfopen
# define	fopen_s	_wfopen
